...
type OAuthHandlers struct {
	googleOAuth *uc.GoogleOAuthUC
}

func NewOAuthHandlers(googleOAuth *uc.GoogleOAuthUC) *OAuthHandlers {
...
func (rc *OAuthHandlers) GoogleCallback(c echo.Context) error {
	...
	user, err := rc.googleOAuth.HandleCallback(c.Request().Context(), input.Code)
	if err != nil {
